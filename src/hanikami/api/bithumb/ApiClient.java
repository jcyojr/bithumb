...
public class ApiClient {
    ...
    private String request(String strHost, String strMemod, HashMap<String, String> rgParams,  HashMap<String, String> httpHeaders) throws SocketTimeoutException {
    	String response = "";
    ...
    public String callApi(String endpoint, HashMap<String, String> params) throws SocketTimeoutException{
